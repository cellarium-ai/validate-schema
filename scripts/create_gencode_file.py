"""Script that creates a gencode file."""
# straight up copy and paste from 
# https://github.com/chanzuckerberg/single-cell-curation/blob/main/cellxgene_schema_cli/scripts/gene_processing.py
...
sys.path.append(os.path.join(os.path.dirname(os.path.realpath(__file__)), "../cellarium_schema"))
import env
...
def main():
    ...
    # define the gencode v43 resource
    gene_infos = {
        "human": {
            "description": "homo_sapiens_v43",
